...
$msg = ""; // Сообщение
$f_size = ""; // Размер файла
$fileElementName = $_GET['fileElementName'];
...
if(!empty($_FILES[$fileElementName]['error'])){
	...
	$f_size.="Размер файла: ".@filesize($upl_file_tmp).'\n';
	...
	// Перенос в папки
	if(move_uploaded_file($upl_file_tmp,$upl_dir.basename($upl_file))){$msg.="Файл верный и успешно загружен.".'\n';
		// Watermark
		if($_GET['watermark']){
