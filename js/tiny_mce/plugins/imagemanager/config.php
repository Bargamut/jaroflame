<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = $_SERVER['DOCUMENT_ROOT'] .'/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = $_SERVER['DOCUMENT_ROOT'] .'/'; // absolute or relative from this script path, required.
