...
((numMonths[0] > 0 && col == numMonths[1] - 1) ? '<div class="ui-datepicker-row-break"></div>' : '') : ''); group += calender;
            ...
            html += group; html +=  this._get(inst, 'timeLabel')+' <select id="DP_jQuery_Hour_' + dpuuid + '">'; for (i = 1; i < 13; i++) {
